...
class Wavegram_Logmel_Cnn14(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        self.convsp1 = nn.Conv2d(in_channels=64,
                                 out_channels=64,
                                 kernel_size=(3, 3), stride=(1, 1),
                                 padding=(1, 1), bias=False)
        self.convsp2 = nn.Conv2d(in_channels=256,
                                 out_channels=256,
                                 kernel_size=(3, 3), stride=(1, 1),
                                 padding=(1, 1), bias=False)
        self.strip_pooling1 = StripPooling(inter_channels_1, (40, 16), strip_bn, up_kwargs)
        self.strip_pooling2 = StripPooling(inter_channels_1, (40, 16), strip_bn, up_kwargs)
        self.strip_pooling3 = StripPooling(inter_channels_2, (20, 12), strip_bn, up_kwargs)
        self.strip_pooling4 = StripPooling(inter_channels_2, (20, 12), strip_bn, up_kwargs)
